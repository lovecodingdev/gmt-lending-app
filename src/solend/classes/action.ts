...
import config_product from "../config.devnet.json"
import config_devnet from "../config.devnet.json"
...
export class SolendAction {
  ...
  static async initialize(
    ...
    // ).data) as ConfigType;
    const solendInfo = (environment === "production" ? config_product : config_devnet) as ConfigType;
